          ...
          <div className="space-y-10 md:space-y-20">
            <div className="flex gap-6 md:gap-12 items-center">
              <div className="relative">
                <div className="w-20 h-20 md:w-32 md:h-32 rounded-2xl md:rounded-[3rem] bg-[#2D5A5A] shadow-2xl border-4 border-white transform -rotate-3 flex items-center justify-center text-white text-3xl md:text-5xl font-black">
                  <i className="ph ph-user"></i>
                </div>
                <div className="absolute -bottom-2 -right-2 w-8 h-8 bg-[#C2B280] text-white rounded-full flex items-center justify-center border-2 border-white text-xs">
